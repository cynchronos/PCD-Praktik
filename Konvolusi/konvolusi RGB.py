...
for brs in range(1,jml_baris-1):
    for klm in range(1,jml_kolom-1):
        for ch in range (jml_channel):
            ...
            a = gambar[brs-1,klm-1,ch] * kernel[0,0]   #kiri atas (Baris sebelum titik tengah dan kolom sebelum titik tengah)
            b = gambar[brs-1,klm,ch] * kernel[0,1]     #tengah atas (Baris sebelum titik tengah dan kolom sama dengan titik tengah)
